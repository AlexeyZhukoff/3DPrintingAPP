<?php
    ...
    function getHtml($sheetName, $columnLimit){
        ...
        if($columnLimit > 0){
            $params[2] = 'endcolumnindex' => $columnLimit;
        }
    ...
    function createMaterial(){
        ...
        setCellValue(SheetNames::Materials, 1, 1, $filename, $materialDensity, $id);
        setCellValue(SheetNames::Materials, 1, 2, $filename, $materialDiameter, $id);
        setCellValue(SheetNames::Materials, 1, 3, $filename, $materialPrice, $id);
